...
export function contactLabel(inbox, me, contact) {
  return contactRevealed(inbox, me, contact) ? contact : 'Anonymous'
}
  ...
  return (
    <div className="rounded-2xl p-4 animate-fade-in transition-all"
      ...
      <div className="flex items-center justify-between">
        <Avatar label="You" initial={meInitial} />
        ...
        <div className="flex-1 flex flex-col items-center px-2">
          ...
          {!awaiting && !accepted && (
            <span className="text-[10px] text-center" style={{ color: 'var(--tp-text-secondary)', opacity: 0.5 }}>
              {declined ? 'Declined' : 'Reader nearby'}
            </span>
          )}
        </div>

        <Avatar
          label={accepted ? revealedName : 'Anonymous'}
