    ...
    <div className="min-h-full px-4 py-6 max-w-2xl mx-auto animate-fade-in">
      ...
      <div className="space-y-6 pb-4">
        <section className="rounded-xl p-5" style={{ backgroundColor: 'var(--tp-surface)', border: '1.5px solid var(--tp-border)' }}>
          <h3 className="text-sm font-bold mb-2" style={{ color: 'var(--tp-text)' }}>{t('about.missionHeading')}</h3>
        ...
        <section className="rounded-xl p-5" style={{ backgroundColor: 'var(--tp-surface)', border: '1.5px solid var(--tp-border)' }}>
          <h3 className="text-sm font-bold mb-2" style={{ color: 'var(--tp-text)' }}>{t('about.historyHeading')}</h3>
          <p className="text-sm leading-relaxed" style={{ color: 'var(--tp-text-secondary)' }}>
            {t('about.historyBody')}
          </p>
        </section>
        ...
        <section className="rounded-xl p-5" style={{ backgroundColor: 'var(--tp-surface)', border: '1.5px solid var(--tp-border)' }}>
          <h3 className="text-sm font-bold mb-2" style={{ color: 'var(--tp-text)' }}>{t('about.blendHeading')}</h3>
          <p className="text-sm leading-relaxed" style={{ color: 'var(--tp-text-secondary)' }}>
            {t('about.blendBody')}
          </p>
        </section>
        ...
        <section className="rounded-xl p-5" style={{ backgroundColor: 'var(--tp-surface)', border: '1.5px solid var(--tp-border)' }}>
          <h3 className="text-sm font-bold mb-2" style={{ color: 'var(--tp-text)' }}>{t('about.safetyHeading')}</h3>
          <p className="text-sm leading-relaxed" style={{ color: 'var(--tp-text-secondary)' }}>
            {t('about.safetyBody')}
          </p>
        </section>
